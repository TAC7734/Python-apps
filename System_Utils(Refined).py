...
# --- Styling & Colors ---
PRIMARY_COLOR = "#007BFF"       # Blue for Launch button
...
def get_network_info():
    ...
    Returns a dictionary keyed by adapter name. IPv6 extraction is removed as requested.
    """
    if platform.system() != "Windows":
    ...
    # IPv6 pattern is commented out, but we keep the logic structure.
...
class SystemUtilityApp:
    def __init__(self, master):
        ...
        # --- Network Info Section with Dropdown (IPv6 removed, Copy button added) ---
        ...
        tk.Label(master, textvariable=self.status_var, font=('Segoe UI', 9, 'italic'), 
                 bg=BACKGROUND_COLOR, fg=TEXT_COLOR).pack(pady=(10, 0), anchor="w")
    ...
    def setup_network_info_section(self):
        ...
        net_frame = tk.LabelFrame(self.master, text="Network Adapter Details", 
                                  ...
                                  padx=15, pady=15, bd=1, relief=tk.RIDGE) # Use RIDGE/GROOVE for smoother border
    ...
    def display_selected_adapter(self, adapter_name):
        ...
        # self.ipv6_label update line removed
