...
class SystemUtilityApp:
    ...
    # --- Launcher Methods (UPDATED FOR NO AUTO-TYPING) ---
    ...
    def setup_launcher_section(self, parent_frame):
        ...
        self.folder_structure_label.grid(row=4, column=0, sticky="ew", padx=5, pady=2, columnspan=2)
    ...
    def select_app_from_list(self, event):
        ...
        if selection:
            ...
            if selected_cleaned_name in self.app_data:
                ...
                # NOTE: The line to set the search_app_var is REMOVED 
                # to keep the user's manual input in the entry box.
