...
def get_network_info():
    ...
    # Removed '(Preferred)' from adapter name pattern for cleaner output
...
class SystemUtilityApp:
    ...
    def convert_number(self):
        ...
        # Clear the result label border to prevent misleading visual feedback on error
    ...
    def copy_converted_value(self):
        ...
        # Check if the output is an error or placeholder message
